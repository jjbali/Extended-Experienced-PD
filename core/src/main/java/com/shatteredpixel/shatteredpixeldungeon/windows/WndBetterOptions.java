...
public class WndBetterOptions extends Window {
	...
	public WndBetterOptions(final String title, final String body, final String initialValue, final int maxLength,
