...
package com.shatteredpixel.shatteredpixeldungeon.actors.mobs.variants.prison;
...
public class NecromancerZ extends Mob {
...
if (enemySeen){
			...
			if (enemySeen && Dungeon.level.distance(pos, enemy.pos) <= 4 && mySkeleton == null){
				...
				for (int c : PathFinder.NEIGHBOURS8){
					if (Actor.findChar(enemy.pos+c) == null
							...
							&& (!hasProp(NecromancerZ.this, Property.LARGE) || Dungeon.level.openSpace[enemy.pos+c])
	...
	public static class NecroSkeleton extends SkeletonZ {
