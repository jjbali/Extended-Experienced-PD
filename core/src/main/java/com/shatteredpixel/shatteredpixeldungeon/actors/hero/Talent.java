	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case DUELIST:
				...
				/*
			case RAT_KING:
				Collections.addAll(tierTalents, HEARTY_MEAL, VETERANS_INTUITION, TEST_SUBJECT,
						IRON_WILL, EMPOWERING_MEAL, SCHOLARS_INTUITION, TESTED_HYPOTHESIS, BACKUP_BARRIER,
		...
		switch (cls){
			...
			case KING:
				Collections.addAll(tierTalents, ENDLESS_RAGE, DEATHLESS_FURY, ENRAGED_CATALYST,
						...
						SOUL_EATER, SOUL_SIPHON, NECROMANCERS_MINIONS,
						...
						SECONDARY_CHARGE, TWIN_UPGRADES, COMBINED_LETHALITY,
