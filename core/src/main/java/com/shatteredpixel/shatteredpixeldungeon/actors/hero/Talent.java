...
//		}
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			case WARRIOR: default:
				Collections.addAll(tierTalents, VETERANS_INTUITION, TEST_SUBJECT, IRON_WILL, QUESTIONNAIRE_SUPERVISOR);
				break;
			case MAGE:
				Collections.addAll(tierTalents, SCHOLARS_INTUITION, TESTED_HYPOTHESIS, BACKUP_BARRIER, QUESTIONNAIRE_SUPERVISOR);
				break;
			case ROGUE:
				Collections.addAll(tierTalents, CACHED_RATIONS, THIEFS_INTUITION, SUCKER_PUNCH, PROTECTIVE_SHADOWS, QUESTIONNAIRE_SUPERVISOR);
				break;
			case HUNTRESS:
				Collections.addAll(tierTalents, NATURES_BOUNTY, FOLLOWUP_STRIKE, QUESTIONNAIRE_SUPERVISOR);
				break;
			case DUELIST:
				Collections.addAll(tierTalents, STRENGTHENING_MEAL, ADVENTURERS_INTUITION, AGGRESSIVE_BARRIER, QUESTIONNAIRE_SUPERVISOR);
				break;
			case RAT_KING:
				Collections.addAll(tierTalents,VETERANS_INTUITION, TEST_SUBJECT, EMPOWERING_MEAL, SCHOLARS_INTUITION,
						TESTED_HYPOTHESIS, CACHED_RATIONS, THIEFS_INTUITION, SUCKER_PUNCH, PROTECTIVE_SHADOWS,
						NATURES_BOUNTY, FOLLOWUP_STRIKE, STRENGTHENING_MEAL, ADVENTURERS_INTUITION, AGGRESSIVE_BARRIER,
						QUESTIONNAIRE_SUPERVISOR);
				break;
		}
		...
		switch (cls){
			case WARRIOR: default:
				Collections.addAll(tierTalents, IRON_STOMACH, RESTORED_WILLPOWER, LETHAL_MOMENTUM, SCROLL_COLLECTOR, POTION_COLLECTOR,
						TREASUREBAG_COLLECTOR);
				break;
			case MAGE:
				Collections.addAll(tierTalents, ENERGIZING_MEAL, WAND_PRESERVATION, SCROLL_COLLECTOR, POTION_COLLECTOR, TREASUREBAG_COLLECTOR);
				break;
			case ROGUE:
				Collections.addAll(tierTalents, MYSTICAL_MEAL, WIDE_SEARCH, ROGUES_FORESIGHT, SCROLL_COLLECTOR, POTION_COLLECTOR,
						TREASUREBAG_COLLECTOR);
				break;
			case HUNTRESS:
				Collections.addAll(tierTalents, INVIGORATING_MEAL, RESTORED_NATURE, HEIGHTENED_SENSES, DURABLE_PROJECTILES, SCROLL_COLLECTOR,
						POTION_COLLECTOR, TREASUREBAG_COLLECTOR);
				break;
			case DUELIST:
				Collections.addAll(tierTalents, FOCUSED_MEAL, RESTORED_AGILITY, LETHAL_HASTE, SWIFT_EQUIP, SCROLL_COLLECTOR,
						POTION_COLLECTOR, TREASUREBAG_COLLECTOR);
				break;
			case RAT_KING:
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case MONK:
				...
				break;
			case KING:
				Collections.addAll(tierTalents, ENDLESS_RAGE, DEATHLESS_FURY, ENRAGED_CATALYST, CLEAVE, LETHAL_DEFENSE,
						EMPOWERED_STRIKE, MYSTICAL_CHARGE, EXCESS_CHARGE, SOUL_SIPHON, ENHANCED_LETHALITY,
						BOUNTY_HUNTER, EVASIVE_ARMOR, SPEEDY_STEALTH, FARSIGHT, SHARED_UPGRADES, SECONDARY_CHARGE,
						TWIN_UPGRADES, UNENCUMBERED_SPIRIT, COMBINED_ENERGY);
				break;
		}
		for (Talent talent : tierTalents){
			talents.get(2).put(talent, 0);
