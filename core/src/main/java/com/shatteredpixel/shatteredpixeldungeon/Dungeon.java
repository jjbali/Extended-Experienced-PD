...
import static com.shatteredpixel.shatteredpixeldungeon.Challenges.*;
...
public class Dungeon {
	...
	public static final int BRANCH_CUSTOM = 4;
	public static final int BRANCH_THIRD = 5;
	public static final int BRANCH_FOURTH = 6;
	public static final int DIMENSIONAL = 8;

	public static boolean isAscensionPossible(){
		return branch != BRANCH_ARENA && branch != BRANCH_CUSTOM && branch != BRANCH_THIRD && branch != BRANCH_FOURTH;
	}
	...
	public static void init() {
		...
		AdditionItem.streak_a = 0;
		SubtractionItem.streak_b = 0;
		MultiplicationItem.streak_c = 0;
		DivisionItem.streak_d = 0;
		ExponentialItem.streak_e = 0;
		MixedOperationItem.streak_f = 0;
		OddEvenItem.streak_g = 0;
		...
		MultiplicationItem.totalAnswers_c = 0;
		DivisionItem.totalAnswers_d = 0;
		ExponentialItem.totalAnswers_e = 0;
		MixedOperationItem.totalAnswers_f = 0;
		OddEvenItem.totalAnswers_g = 0;
		...
		if (Objects.equals(customSeedText, "MOR-EMO-NEY")) {
			gold *= 3216344;
		}
		if (Objects.equals(customSeedText, "CHA-RAC-TER")) {
			Buff.affect(hero, AnkhInvulnerability.class, Float.MAX_VALUE);
	...
	public static Level newLevel() {
		...
		if (!(level instanceof GlitchedLevel)){
	...
	public static long seedForDepth(int depth, int branch){
		int lookAhead = depth;
		lookAhead += 23 * branch; //Assumes depth is always 1-30, and branch is always 0 or higher
	...
	public static boolean shopOnLevel2() {
		return true;
	}

	public static boolean shopOnLevel3() {
		return true;
	}
	...
	public static boolean posNeeded() {
		...
		int posLeftThisSet = 4 - (LimitedDrops.STRENGTH_POTIONS.count - (depth / 5) * 2);
	...
	public static boolean souNeeded() {
		...
		souLeftThisSet = 4 - (LimitedDrops.UPGRADE_SCROLLS.count - (depth / 5) * 3);
	...
	private static final String SPECIAL_SEED	= "specialSeed";
