...
public class TestPotion extends TestGenerator {
    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_GIVE) && hero.buff(PotionOfDebug.DebugCooldown.class) == null ) {
    ...
    private void createItem(){
        ...
        if (item != null) {
            ...
            if(collect){
                int qu = item_quantity * (multiply?10:1);
                GLog.i(Messages.get(this, "collect_success", item.name(), qu));
            }else{
                item.doDrop(curUser);
            }
        }
    ...
    private Class<? extends Item> idToItem(int id){
        switch (cateSelected){
            ...
            case 12: default: return idToMisc2(id);
        }
    }
    ...
    private int idToCategoryImage(int selected){
        switch (selected){
            ...
            case 12: return ItemSpriteSheet.MAGIC_INFUSE;
        }
    }
    ...
    private Class<? extends Item> idToMisc2(int id){
        switch (id){
            case 0: default: return TicketToArena.class;
            case 1: return TicketToSecondArena.class;
            case 2: return TicketToThirdArena.class;
            case 3: return RandomItemTicket.class;
            case 4: return ExpGenerator.class;
            case 5: return AlchemyBag.class;
            case 6: return BiggerGambleBag.class;
            case 7: return GambleBag.class;
            case 8: return MiscBag.class;
            case 9: return PotionBag.class;
            case 10: return QualityBag.class;
            case 11: return ScrollBag.class;
            case 12: return TicketToFourthArena.class;
            case 13: return RandomBuffGiver.class;
        }
    }
    ...
    private class SettingsWindow extends Window {
        ...
        public SettingsWindow() {
            ...
            o_quantity = new OptionSlider(Messages.get(this, "quantity"), "1", "100", 1, 100) {
                @Override
