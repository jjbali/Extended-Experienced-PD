...
public class TrapPlacer extends TestItem {
    ...
    static {
        ...
        trapLib.put(5, CannonTrap.class);
        trapLib.put(8, ChestnutTrap.class);
        trapLib.put(9, CryoTrap.class);
        trapLib.put(10, CursedWandTrap.class);
        trapLib.put(15, CursingTrap.class);
        trapLib.put(16, EnchantingTrap.class);
        trapLib.put(17, FlashingTrap.class);
        trapLib.put(18, FloodTrap.class);
        trapLib.put(21, GuardianTrap.class);
        trapLib.put(22, HealingTrap.class);
        trapLib.put(27, InfernoTrap.class);
        trapLib.put(29, LotteryTrap.class);
        trapLib.put(34, MimicTrap.class);
        trapLib.put(35, MultiTrap.class);
        trapLib.put(37, OvergrowthTrap.class);
        trapLib.put(38, ParalyticTrap.class);
        trapLib.put(40, PoisonDartTrap.class);
        trapLib.put(41, RockfallTrap.class);
        trapLib.put(42, SlicingTrap.class);
        trapLib.put(46, SmokescreenTrap.class);
        trapLib.put(49, SpookTrap.class);
        trapLib.put(51, TenguDartTrap.class);
    }
