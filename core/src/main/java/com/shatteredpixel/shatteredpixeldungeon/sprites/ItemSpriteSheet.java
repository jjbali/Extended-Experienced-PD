...
public class ItemSpriteSheet {
	...
	public static final int ARMOR_LIMINAL   = ARMOR+11;
	static{
		...
		assignItemRect(ARMOR_LIMINAL,   12, 12);
	}
	...
	public static final int BOW_ENERGY			= ENERGY_WEP+11;
	public static final int GREATSWORD_ENERGY			= ENERGY_WEP+12;
	static{
		...
		assignItemRect(BOW_ENERGY				, 16, 16);
		assignItemRect(GREATSWORD_ENERGY				, 16, 16);
	}
	...
	public static final int BROWN		= FRAGMENTS+6;
	public static final int TEAL		= FRAGMENTS+7;
	public static final int MAGENTA		= FRAGMENTS+8;
	public static final int WHITE		= FRAGMENTS+9;
	static{
