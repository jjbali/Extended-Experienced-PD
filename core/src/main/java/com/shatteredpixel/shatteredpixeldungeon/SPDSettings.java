...
public class SPDSettings extends GameSettings {
	...
	public static final String KEY_LOGMISC= "logging_option_misc";
	public static final String KEY_LOGOTHER= "logging_option_other";
	...
	public static int seedfinderFloors() {
		return getInt( KEY_FLOORS, 1, 1, 100 );
	}
	...
	public static void logOther( boolean value ) {
		put( KEY_LOGOTHER, value );
	}
	public static boolean logOther() {
		return getBoolean( KEY_LOGOTHER, false );
	}
...
public static void playMusicInBackground( boolean value ){
	...
	public static final String MODIFIER_HP = "HP";
	public static final String DEBUG = "DEBUG";


	public static void healthMod(int value) {
		put( MODIFIER_HP, value );
	}

	public static int healthMod(){
		return getInt(MODIFIER_HP, 1, 1, 20);
	}

	public static void debuggable( boolean value ){
		put( DEBUG, value );
	}
