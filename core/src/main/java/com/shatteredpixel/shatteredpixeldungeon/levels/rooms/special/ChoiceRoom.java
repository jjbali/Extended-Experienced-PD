...
public class ChoiceRoom extends SpecialRoom {
	...
	public void paint(Level level) {
		...
		if (entrance.x == left){
			...
			Painter.set(level, new Point(entry.right+1, (room1.top + room1.bottom + 1)/2), Terrain.LOCKED_DOOR);
			Painter.set(level, new Point(entry.right+1, (room2.top + room2.bottom)/2), Terrain.LOCKED_DOOR);
			...
			Painter.set(level, new Point((room1.left + room1.right + 1)/2, entry.bottom+1), Terrain.LOCKED_DOOR);
			Painter.set(level, new Point((room2.left + room2.right)/2, entry.bottom+1), Terrain.LOCKED_DOOR);
			...
			Painter.set(level, new Point(entry.left-1, (room1.top + room1.bottom + 1)/2), Terrain.LOCKED_DOOR);
			Painter.set(level, new Point(entry.left-1, (room2.top + room2.bottom)/2), Terrain.LOCKED_DOOR);
			...
			Painter.set(level, new Point((room1.left + room1.right + 1)/2, entry.top-1), Terrain.LOCKED_DOOR);
			Painter.set(level, new Point((room2.left + room2.right)/2, entry.top-1), Terrain.LOCKED_DOOR);
