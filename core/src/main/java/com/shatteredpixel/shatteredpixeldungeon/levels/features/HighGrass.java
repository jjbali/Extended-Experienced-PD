		...
		if (level.map[pos] == Terrain.FURROWED_GRASS){
			...
			if (ch instanceof Hero) {
				...
				if (hero.belongings.armor() != null && hero.belongings.armor().hasGlyph(Camouflage.class, hero)) {
					Camouflage.activate((Char) hero, (int) hero.belongings.armor.buffedLvl());
				}
				...
				if (ghost.armor() != null && ghost.armor().hasGlyph(Camouflage.class, ghost)){
					Camouflage.activate((Char) ghost, (int) ghost.armor().buffedLvl());
				}
				...
				if (statue.armor() != null && statue.armor().hasGlyph(Camouflage.class, statue)){
					Camouflage.activate((Char) statue, (int) statue.armor().buffedLvl());
				}
			}
