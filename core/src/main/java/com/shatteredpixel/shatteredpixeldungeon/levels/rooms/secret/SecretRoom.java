...
public abstract class SecretRoom extends SpecialRoom {
	...
	private static final ArrayList<Class<? extends SecretRoom>> ALL_SECRETS = new ArrayList<>( Arrays.asList(
			...
			SecretHoardRoom.class, SecretMazeRoom.class, SecretSummoningRoom.class, SecretSpellRoom.class));
	...
	private static float[] baseRegionSecrets = new float[]{2f, 2.1f, 2.2f, 2.3f, 2.4f, 2.5f, 2.6f, 2.7f, 2.8f, 2.9f, 3f, 3.1f, 3.2f, 3.3f, 3.4f, 3.5f, 3.6f, 3.7f, 3.8f, 3.9f, 4f, 4.1f, 4.2f };
	private static int[] regionSecretsThisRun = new int[23];
