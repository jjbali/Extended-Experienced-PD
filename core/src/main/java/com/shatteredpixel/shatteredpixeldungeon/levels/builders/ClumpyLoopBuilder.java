...
public class ClumpyLoopBuilder extends RegularBuilder {
    ...
    public ClumpyLoopBuilder setLoopShape(int exponent, float intensity, float offset){
    ...
    public ArrayList<Room> build(ArrayList<Room> rooms) {
        ...
        float startAngle = Random.Int(4) * 90;
        ...
        for (Room r : mainPathRooms){
            ...
            for (int j = 0; j < tunnels; j++){
                loop.add(StandardRoom.createRoom());
            }
        }
        ...
        while (!prev.connect(entrance)){
            ...
            StandardRoom c = StandardRoom.createRoom();
