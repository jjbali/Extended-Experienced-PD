...
public class Generator {
	...
	public static Armor randomArmor(){
		return randomArmor(Dungeon.depth / 20);
	}
	...
	public static MeleeWeapon randomWeapon(){
		return randomWeapon(Dungeon.depth / 20);
	}
	...
	public static MeleeWeapon randomWeapon(boolean useDefaults) {
		return randomWeapon(Dungeon.depth / 20, useDefaults);
	}
	...
	public static MissileWeapon randomMissile(){
		return randomMissile(Dungeon.depth / 20);
	}
	...
	public static MissileWeapon randomMissile(boolean useDefaults) {
		return randomMissile(Dungeon.depth / 20, useDefaults);
	}
