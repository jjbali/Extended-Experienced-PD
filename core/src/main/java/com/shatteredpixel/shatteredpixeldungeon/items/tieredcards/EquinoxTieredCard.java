...
public class EquinoxTieredCard extends Item {

    private static final String AC_DRINK	= "DRINK";

    {
        image = ItemSpriteSheet.EQUINOX_TIERED;
        identify();
        stackable = false;
        unique = true;
    }
    ...
    public void execute(final Hero hero, String action ) {
        ...
        if (action.equals(AC_DRINK)) {
            long rolls = 5L * (AdditionItem.streak_a + SubtractionItem.streak_b
    ...
    @Override
    public String name() {
        return "Equinox Tiered Card";
    }

    @Override
    public String desc() {
        return "Gives random item based on questionnaire streaks, it is upgradable until it reaches 100.";
    }
