...
public class BallisticBow extends Weapon {
	
	public static final String AC_SHOOT		= "SHOOT";
	
	{
		image = ItemSpriteSheet.BOW_ENERGY;
	...
	public long min(long lvl) {
		long dmg = 10 + 2*RingOfSharpshooting.levelDamageBonus(Dungeon.hero)
	...
	public long max(long lvl) {
		long dmg = 20 + 3*RingOfSharpshooting.levelDamageBonus(Dungeon.hero)
	...
	public class SpiritArrow extends MissileWeapon {
		...
		@Override
		public long damageRoll(Char owner) {
			return BallisticBow.this.damageRoll(owner);
		}
		
		@Override
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return BallisticBow.this.hasEnchant(type, owner);
		}
		
		@Override
		public long proc(Char attacker, Char defender, long damage) {
			return BallisticBow.this.proc(attacker, defender, damage);
		}
		
		@Override
		public float delayFactor(Char user) {
			return BallisticBow.this.delayFactor(user);
		}
		
		@Override
		public float accuracyFactor(Char owner, Char target) {
			if (sniperSpecial && BallisticBow.this.augment == Augment.DAMAGE){
		...
		@Override
		public int STRReq(long lvl) {
			return BallisticBow.this.STRReq();
		}
		...
		protected void onThrow( int cell ) {
			...
			if (enemy == null || enemy == curUser) {
				...
				if (sniperSpecial && BallisticBow.this.augment != Augment.SPEED) sniperSpecial = false;
			}
		}
		...
		public void cast(final Hero user, final int dst) {
			...
			BallisticBow.this.targetPos = cell;
			if (sniperSpecial && BallisticBow.this.augment == Augment.SPEED){
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(BallisticBow.class, "prompt");
		}
	};
}
