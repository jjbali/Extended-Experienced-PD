    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_USE)){
            if (Dungeon.branch != Dungeon.BRANCH_ARENA){
                ...
                InterlevelScene.curTransition = new LevelTransition(Dungeon.level, -1, LevelTransition.Type.BRANCH_EXIT, 102, Dungeon.BRANCH_ARENA, LevelTransition.Type.BRANCH_ENTRANCE);
