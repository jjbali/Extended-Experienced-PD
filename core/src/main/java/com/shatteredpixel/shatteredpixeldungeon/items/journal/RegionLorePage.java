...
public class RegionLorePage {
	...
	public static DocumentPage pageForDoc( Document doc ){
		switch (doc){
			...
			case ONE:                		return new RegionLorePage.OneDocumentation();
			case TWO:                		return new RegionLorePage.TwoDocumentation();
		}
	}

	public static class TwoDocumentation extends DocumentPage {
		{
		...
		public ItemSprite.Glowing glowing() {
			return new ItemSprite.Glowing( 0x220033, 0.1f);
		}
	}

	public static class OneDocumentation extends DocumentPage {
		{
			image = ItemSpriteSheet.ADVANCED_EVOLUTION;
		}
