...
public class BallisticCrossbow extends JjbaliWeapon {

	{
		image = ItemSpriteSheet.CROSSBOW_ENERGY;
                    ...
                    public void call() {
                        ...
                        for (int cell: cone.cells){
                            ...
                            if (ch != null && !(ch instanceof Bbat)) {
                                ...
                                Buff.affect(ch, Weakness.class, 20);
                                Buff.affect(ch, Blindness.class, 30);
