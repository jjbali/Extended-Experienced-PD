...
public class BallisticGreatsword extends MeleeWeapon {

	{
		image = ItemSpriteSheet.GREATSWORD_ENERGY;
    ...
    public String statsInfo() {
        return Messages.get(this, "stats_desc", 17 + Dungeon.escalatingDepth() * 5);
    }
    ...
    public long proc(Char attacker, Char defender, long damage) {
        for (int i : PathFinder.NEIGHBOURS9){
            ...
            if (!Dungeon.level.solid[attacker.pos + i]
                ...
                BallisticGreatsword copy = new BallisticGreatsword();
                copy.level(level());
    ...
    public static class GuardianKnight extends Statue {
        ...
        public GuardianKnight() {
            HP = HT = 17 + Dungeon.escalatingDepth() * 5;
            defenseSkill = 12 + Dungeon.escalatingDepth();
        }
