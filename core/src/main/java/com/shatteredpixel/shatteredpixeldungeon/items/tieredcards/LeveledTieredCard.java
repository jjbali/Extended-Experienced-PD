...
public class LeveledTieredCard extends Item {

    private static final String AC_DRINK	= "DRINK";

    {
        image = ItemSpriteSheet.LEVELED_TIERED;
    ...
    public void execute(final Hero hero, String action ) {
        ...
        if (action.equals(AC_DRINK)) {
            long rolls = (9L + level()) * Dungeon.hero.lvl;
    ...
    @Override
    public String name() {
        return "Leveled Tiered Card";
    }

    @Override
    public String desc() {
        return "Gives random item based on your level, it is upgradable until it reaches 100.";
    }
