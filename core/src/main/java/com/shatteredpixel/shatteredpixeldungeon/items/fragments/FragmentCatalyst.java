...
public class FragmentCatalyst extends Item {
	...
	public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe {
		...
		public boolean testIngredients(ArrayList<Item> ingredients) {
			return ingredients.size() == 1 && ingredients.get(0) instanceof FragmentCatalyst;
		}
		...
		public Item sampleOutput(ArrayList<Item> ingredients) {
			return new Fragment.PlaceHolder();
		}
	}
	...
	public static class WndTrinket extends Window {
		...
		public WndTrinket(){
			...
			FragmentCatalyst cata = new FragmentCatalyst();
			...
			RenderedTextBlock message = PixelScene.renderTextBlock( Messages.get(FragmentCatalyst.class, "window_text"), 6 );
			...
			for (int i = 1; i <= NUM_TRINKETS; i++){
				...
				btnReward.item(Generator.random(Generator.Category.FRAGMENTS));
			...
			public RewardWindow( Item item ) {
				...
				RedButton btnConfirm = new RedButton(Messages.get(WndSadGhost.class, "confirm")){
					...
					protected void onClick() {
						...
						FragmentCatalyst cata = Dungeon.hero.belongings.getItem(FragmentCatalyst.class);
