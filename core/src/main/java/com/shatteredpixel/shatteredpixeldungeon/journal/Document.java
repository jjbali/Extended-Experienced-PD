...
public enum Document {
	...
	ONE(ItemSpriteSheet.ADVANCED_EVOLUTION, true),
	TWO(ItemSpriteSheet.TELE_GRAB, true);
	...
	static {
		...
		HALLS_KING.pagesStates.put("attrition", READ);

		ONE.pagesStates.put("beginning", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("secondary_secret", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("distorted_lands", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("perfectionist", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("expansion", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("food_machine", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("ending", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		ONE.pagesStates.put("true_ending", DeviceCompat.isDebug() ? READ : NOT_FOUND);

		TWO.pagesStates.put("first_fist_adaption", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("farlands", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("aggression", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("stock", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("titles", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("dropped", DeviceCompat.isDebug() ? READ : NOT_FOUND);
		TWO.pagesStates.put("end", DeviceCompat.isDebug() ? READ : NOT_FOUND);
	}
