...
public class Statistics {
	...
	public static int elite_enemies;
	public static float second_elapsed;
	public static double real_seconds;
	public static float turnsPassed;
	public static int answeredQuestions;
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		answeredQuestions = bundle.getInt( ANSWERED_Q );
